 ...
 */
class Woo_UB_Brands_Filter_Widget extends WP_Widget {
...
function woo_ub_filter_register_widget() {
	register_widget( 'Woo_UB_Brands_Filter_Widget' );
}
add_action( 'widgets_init', 'woo_ub_filter_register_widget' );
